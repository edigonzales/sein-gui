...
m.get_root().html.add_child(folium.Element(proj4leaflet_js))
m.get_root().html.add_child(folium.Element("<script src='https://raw.githubusercontent.com/edigonzales/sein-gui/refs/heads/main/epgs2056.js'></script>"))
